...
public final class KLineVolStat extends DailyFeatureStat implements Featurable {
    public final static KLineVolStat INVALID = new KLineVolStat(Security.UNKNOWN, LocalDate.MIN, LocalTime.MIN,
            NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);

    public KLineVolStat(Security s_, LocalDate d_, LocalTime t_, double q5_, double q10_, double q20_, double q30_, double q40_,
