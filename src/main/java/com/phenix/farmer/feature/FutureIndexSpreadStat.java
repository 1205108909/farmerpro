...
public class FutureIndexSpreadStat extends DailyFeatureStat implements Featurable {
    public final static FutureIndexSpreadStat INVALID = new FutureIndexSpreadStat(Security.UNKNOWN, LocalDate.MIN, LocalTime.MIN,
            NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);

    public FutureIndexSpreadStat(Security s_, LocalDate d_, LocalTime t_, double q5_, double q10_, double q20_, double q30_, double q40_,
