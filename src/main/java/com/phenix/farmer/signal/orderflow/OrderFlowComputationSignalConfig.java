...
public class OrderFlowComputationSignalConfig implements IEngineConfig {
    @Getter
    ...
    public final static OrderFlowComputationSignalConfig DEFAULT = new OrderFlowComputationSignalConfig();
    static {
